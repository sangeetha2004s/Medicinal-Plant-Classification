...
Project Overview
- Goal: Predict the type of medicinal plant from an image.
...
- amla.jpg, castor.jpg, bamboo.jpg, aloevera.jpg: Sample images for testing.
...
5. Run the Streamlit App:
   ...
   - Upload an image in the web interface to see the predicted plant type.
...
- Sample Images: Test with provided images like amla.jpg or aloevera.jpg.
